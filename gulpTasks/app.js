...
gulp.task('app.html', function () {
   gulp.src('app_modulos/**/*.html') //pega todos os arquivos HTML indepedentes de qual
      //subpasta (**) esteja
      .pipe(htmlmin({
         collapseWhitespace: true
      })) //reduz o HTML para deixar o menor possivel
      .pipe(gulp.dest('public')); //copia todos os arquivos HTML para dentro da pasta public

   gulp.src(['app_modulos/app/**/*.html',
         'app_modulos/usuario/cliente/views/*.html'
      ])
      //subpasta (**) esteja
      .pipe(htmlmin({
         collapseWhitespace: true
...
gulp.task('app.css', function () {
   gulp.src('app_modulos/**/*.css') //pega todos os arquivos CSS indepedentes de qual
      //subpasta (**) esteja
      .pipe(uglifycss({
         "uglyComments": true
      })) //reduz o HTML para deixar o menor possivel
...
gulp.task('app.js', function () {
   gulp.src(['app_modulos/**/*.js',
        //  'app_modulos/**/**/*.js',
        //  'app_modulos/usuario/**/**/*.js',
        //  'app_modulos/usuario/servidor/services/autenticacaoServicesv',
         '!app_modulos/*/servidor/**/*.js', // os arquivos do server não podem ser enviados ao public.. BUGA!
         '!app_modulos/*/servidor/routes/*.js' // os arquivos do server não podem ser enviados ao public.. BUGA!
      ]) //pega todos os arquivos JS indepedentes de qual
      //subpasta (**) esteja
      .pipe(babel({
         presets: ['es2015']
      })) //converte todos os comandos do ECMAScript2015 para o anterior
