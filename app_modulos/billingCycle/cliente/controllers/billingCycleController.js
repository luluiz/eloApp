...
(function () {
   ...
   angular.module('eloApp').controller('BillingCycleCtrl', [
      ...
      vm.refresh = function () {
         ...
         $http.get(`${url}?skip=${(page - 1) * 8}&limit=8`).then(function (response) {
            vm.billingCycle = {
               credits: [{}],
               debts: [{}]
            }; //zerando o atributo billingCycle
            ...
            $http.get(`${url}/count`).then(function (response) {
               ...
               tabs.show(vm, {
                  tabList: true,
                  tabCreate: true
               }); //passando os estados das abas ativadas
            });
         });
      };
